...
export default function RegisterRecipients() {
  ...
  const schema = Yup.object().shape({
    ...
    ufInput:Yup.string().test('len', 'A sigla precisa conter exatamente 2 letras', val=>val.length===2).required('A sigla do estado é obrigatória'),
  ...
  return (
    <>
      <Title>
      <header>
          {recipient === null ? <h1>Cadastro do destinatário</h1> : <h1>Edição do destinatário</h1>}
        </header>
      </Title>
      <Container>
        {/* <Link to="/recipients"> */}
