...
import {
  Container, NameLabel, Name, Email, EmailLabel, DateLabel,
  RegisteredDate, ButtonLogout, Info, Image, ButtonText
} from './styles';
...
export default function Profile() {
  ...
  const url = deliveryman.avatar.url;
  ...
  return (
    <Container>
      ...
      <Info>
        ...
        <RegisteredDate>{format(parseISO(deliveryman.createdAt), 'dd/MM/yyyy')}</RegisteredDate>
